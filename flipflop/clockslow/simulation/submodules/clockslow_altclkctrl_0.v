...
module  clockslow_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //clockslow_altclkctrl_0_sub
...
module  clockslow_altclkctrl_0  (
    ...
    clockslow_altclkctrl_0_sub  clockslow_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
